...
KnobComponent.ɵfac = function KnobComponent_Factory(t) { return new (t || KnobComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
KnobComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: KnobComponent, selectors: [["ngx-knob"]], inputs: { value: "value", options: "options", label: "label" }, outputs: { valueChange: "valueChange" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], decls: 0, vars: 0, template: function KnobComponent_Template(rf, ctx) { }, encapsulation: 2 });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(KnobComponent, [{
        type: Component,
        args: [{
                template: '',
                selector: 'ngx-knob'
...
KnobModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({});
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(KnobModule, { declarations: [KnobComponent], exports: [KnobComponent] }); })();
