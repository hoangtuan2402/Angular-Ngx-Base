(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('d3'), require('d3-selection-multi'), require('lodash-es/merge')) :
    typeof define === 'function' && define.amd ? define('@xmlking/ngx-knob', ['exports', '@angular/core', 'd3', 'd3-selection-multi', 'lodash-es/merge'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.xmlking = global.xmlking || {}, global.xmlking['ngx-knob'] = {}), global.ng.core, global.d3, null, global.merge));
}(this, (function (exports, core, d3, d3SelectionMulti, merge) { 'use strict';
    ...
    var KnobComponent = /** @class */ (function () {
        function KnobComponent(el) {
            this.el = el;
            ...
            this.animations = {
                linear: d3__namespace.easeLinear,
                bounce: d3__namespace.easeBounce,
            };
        }
        KnobComponent.prototype.ngOnInit = function () {
            this.inDrag = false;
            // this.options = (<any>Object).assign(this.defaultOptions, this.options);
            this.options = merge__default['default'](this.defaultOptions, this.options);
            this.draw();
        };
        KnobComponent.prototype.ngOnChanges = function (changes) {
            if (this.defaultOptions != null &&
                changes.options != null &&
                changes.options.currentValue != null &&
                this.value != null) {
                this.options = merge__default['default'](this.defaultOptions, changes.options.currentValue);
                this.draw();
            }
            if (this.defaultOptions != null &&
                this.options != null &&
         ...
         */
        KnobComponent.prototype.valueToRadians = function (value, valueEnd, angleEnd, angleStart, valueStart) {
         ...
         */
        KnobComponent.prototype.radiansToValue = function (radians, valueEnd, valueStart, angleEnd, angleStart) {
            valueEnd = valueEnd || 100;
            valueStart = valueStart || 0;
            angleEnd = angleEnd || 360;
            angleStart = angleStart || 0;
         ...
         *   Create the arc
         */
        KnobComponent.prototype.createArc = function (innerRadius, outerRadius, startAngle, endAngle, cornerRadius) {
            var arc = d3__namespace
                .arc()
         ...
         *   Draw the arc
         */
        KnobComponent.prototype.drawArc = function (svg, arc, label, style, click, drag) {
            var elem = svg
                .append('path')
                .attr('id', label)
                .attr('d', arc);
         ...
         *   Create the arcs
         */
        KnobComponent.prototype.createArcs = function () {
         ...
         *   Draw the arcs
         */
        KnobComponent.prototype.drawArcs = function (clickInteraction, dragBehavior) {
            var fontFamily = '';
            var svg = d3__namespace
                .select(this.element)
                .append('svg')
            ...
            if (this.options.displayInput) {
                var fontSize = this.options.size * 0.2 + 'px';
            ...
            if (this.options.scale.enabled) {
                ...
                if (this.options.scale.type === 'dots') {
                    ...
                    data = d3__namespace.range(quantity_1).map(function () {
         ...
         *   Draw knob component
         */
        KnobComponent.prototype.draw = function () {
            d3__namespace.select(this.element)
                .select('svg')
                .remove();
            var that = this;
            that.createArcs();
            var dragBehavior = d3__namespace
                .drag()
            ...
            if (that.options.animate.enabled) {
                ...
                that.valueElem
                    ...
                    .tween('', function () {
                    var i = d3__namespace.interpolate(that.valueToRadians(that.options.startAngle, 360), that.valueToRadians(that.value, that.options.max, that.options.endAngle, that.options.startAngle, that.options.min));
                    return function (t) {
                        var val = i(t);
            ...
            function dragInteraction() {
                that.inDrag = true;
                // @ts-ignore
                var x = d3__namespace.event.x - that.options.size / 2;
                // @ts-ignore
                var y = d3__namespace.event.y - that.options.size / 2;
                interaction(x, y, false);
            }
            function clickInteraction() {
                that.inDrag = false;
                // @ts-ignore
                var coords = d3__namespace.mouse(this.parentNode);
            ...
            function interaction(x, y, isFinal) {
                ...
                if (that.value >= that.options.min && that.value <= that.options.max) {
                    ...
                    if (that.options.displayInput) {
                        ...
                        d3__namespace.select(that.element)
                            .select('#text')
         ...
         *   Set a value
         */
        KnobComponent.prototype.setValue = function (newValue) {
    ...
    KnobComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=xmlking-ngx-knob.umd.js.map
