...
class FieldType$1 extends FieldType {
    ...
    ngAfterViewInit() {
        if (this.matPrefix || this.matSuffix) {
             ...
             */
            () => {
                ɵdefineHiddenProp(this.to, '_matPrefix', this.matPrefix);
                ɵdefineHiddenProp(this.to, '_matSuffix', this.matSuffix);
...
FormlyWrapperFormField.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: FormlyWrapperFormField, selectors: [["formly-wrapper-mat-form-field"]], viewQuery: function FormlyWrapperFormField_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, dependencies: [ɵngcc3.NgIf, ɵngcc3.NgTemplateOutlet, ɵngcc4.MatError, ɵngcc4.MatFormField, ɵngcc4.MatHint, ɵngcc4.MatLabel, ɵngcc4.MatPrefix, ɵngcc4.MatSuffix, ɵngcc1.ɵc], styles: ["formly-wrapper-mat-form-field .mat-form-field{width:100%}"], encapsulation: 2 });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FormlyWrapperFormField, [{
  ...
  `, providers: [{ provide: MatFormFieldControl, useExisting: FormlyWrapperFormField }], encapsulation: ViewEncapsulation.None, styles: ["formly-wrapper-mat-form-field .mat-form-field{width:100%}"] }]
...
FormlyMatFormFieldModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [CommonModule,
        ReactiveFormsModule,
        MatFormFieldModule,
