...
export declare class FormlyField implements OnInit, OnChanges, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<FormlyField, "formly-field", never, { "model": "model"; "form": "form"; "options": "options"; "field": "field"; }, { "modelChange": "modelChange"; }, never, never, false>;
}
